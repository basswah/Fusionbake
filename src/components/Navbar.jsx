...
window.addEventListener ("scroll" , () => {
  ...
  return (
    <div className=" bg-cardBg fixed w-full z-20 duration-500" id="NavBar">
          ...
          >
            {NavbarMenu.map((menu) => (
              <li key={menu.id}>
                <a
                  href={`#${menu.links}`}
                  className=" inline-block py-3 px-3 max-lg:px-2 font-bold hover:text-primary hover:border-b-2 border-primary duration-200 font-lato"
                >
                  {menu.title}
                </a>
              </li>
