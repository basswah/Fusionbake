  ...
  return (
    <section>
      ...
      <div className="bg-primary  ">
        <div className=" h-[40px] grid md:grid-cols-3 grid-cols-2 place-content-center place-items-center ">
          <div className="hidden  md:flex  items-center justify-end w-full text-white col-span-2">
            <h1 className=" font-lato font-semibold">
              Rue pré-du-marché 34 1004 Lausanne, Switzerland
            </h1>
          </div>
          {/* Social Media Section  */}
          <div className="flex w-full max-md:col-span-2 px-3 items-center justify-center gap-2 ">
      ...
      {/* Image Section  */}
      <div className="">
        <img src={HeroImg} alt="HeroImage" className="-mt-10" />
      </div>
    </section>
  );
};
