    ...
    <footer style={bgImage}>
      <div className="  relative">
        <div className="relative z-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 max-lg:py-16 place-items-center">
            {/* Logo Section  */}
            <div className="max-md:mb-12 w-fit h-fit  ">
            ...
            <div className=" flex flex-col items-center justify-center space-y-8 relative z-10 text-white text-lg xl:text-3xl font-lato font-semibold  ">
              ...
              <div className="w-full space-y-8 text-xl lg:text-2xl">
                <div className="flex gap-2 items-center justify-center text-center">
                  <IoCallOutline />
                  <a
                    href="tel:+41 77 923 33 73"
                    className="hover:text-primary duration-200 w-[60%]"
                  >
                ...
                <div className="flex gap-2 items-center justify-center text-center">
                  <IoMailOpenOutline />
                  <a
                    href="mailto:contact@fusionbake.ch"
        ...
        <div className="h-20 md:h-20 relative flex justify-center items-center text-center max-md:mt-2 z-40 ">
          <div className="text-xs md:text-xl text-white w-[80vw]">
            <h1 className="long-text-center">
              Tous droits réservés{" "}
              <a href="" className="hover:text-primary duration-200">
                A.B Marketing & Programming 2024 ©. <br />
              </a>
